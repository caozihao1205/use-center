import argparse
import torch
from model9_NS_transformer.exp.exp_td import Exp_Main
import random
import numpy as np
import setproctitle
import os
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, default='TMDM', help='model id')
    parser.add_argument('--model', type=str, default='60_30',
    ...
    parser.add_argument('--seed', type=int, default=7940, help='random seed')
    ...
    parser.add_argument('--CART_input_x_embed_dim', type=int, default=128, help='feature dim for x in diffusion model')
