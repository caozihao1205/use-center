...
from layers.Embed import DataEmbedding, ADataEmbedding
import yaml
import argparse
from model9_NS_transformer.diffusion_models.diffusion_utils import *
from model9_NS_transformer.diffusion_models.new_model import ConditionalGuidedModel
from model9_NS_transformer.diffusion_models.transformer_model import ResNet
...
class Model(nn.Module):
    ...
    #     dec_out = self.tran_diffussion_model(x,x_mark,y_mark,y_t,y_0_hat,diffusion_step)
    #     return dec_out